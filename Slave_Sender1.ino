...
//initializing data1 to store the value of distance for this sensor
int data1;

RF24 radio(7,8); // nRF24L01 (CE,CSN)
RF24Network network(radio); // Include the radio in the network
const uint64_t this_node = 01; // address of this node
const uint16_t node00 = 00; //address of master node
